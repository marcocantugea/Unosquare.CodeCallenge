...
{
    public partial class installtables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductWarehouseInfo", x => new { x.productsid, x.warehouseInfoid });
                    table.ForeignKey(
                        name: "FK_ProductWarehouseInfo_Products_productsid",
                        column: x => x.productsid,
                        principalTable: "Products",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductWarehouseInfo_WarehouseInfo_warehouseInfoid",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "MWDC", "Monterrey Warehouse Distrubution Center" },
                    { 2, true, "MXDC", "Mexico Warehouse Distrubution Center" },
                    { 3, true, "GDDC", "Guadalajara Warehouse Distrubution Center" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductWarehouseInfo_warehouseInfoid",
                table: "ProductWarehouseInfo",
